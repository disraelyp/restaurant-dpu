...
public class Ioc {
  ...
  public void add(String key, Object value) {
    ...
    var validatedKey =
        optionalKey.filter(k -> !instances.containsKey(k)).orElseThrow(DuplicatedKeyException::new);
  ...
  public <T> T get(String key) {
    ...
    var validatedKey =
        optionalKey.filter(instances::containsKey).orElseThrow(KeyNotFoundException::new);
